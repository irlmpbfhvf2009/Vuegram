      ...
      <ul class="msg-box">
        ...
        <li>
          ...
          <el-radio-group v-model="rechargeParams.paymentType" @change="paymentTypeChange">
            <el-radio border :label="'' + 0">支付宝资金专用UID</el-radio>
            <el-radio border :label="'' + 1">支付宝缴费</el-radio>
            <el-radio border :label="'' + 2">支付宝龙猫</el-radio>
            <el-radio border :label="'' + 3">腾讯游戏点券</el-radio>
            <el-radio border :label="'' + 4">QQ面对面红包</el-radio>
          </el-radio-group>
        </li>
