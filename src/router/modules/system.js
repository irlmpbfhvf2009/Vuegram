...
const route = [
  ...
  // {
  //   path: '/jobSeekerForm',
  //   component: createNameComponent(() => import('@/views/main/springyBot/jobManagement/form/jobSeekerForm.vue')),
  //   hideMenu: true,
  ...
  // {
  //   path: '/jobPostingForm',
  //   component: createNameComponent(() => import('@/views/main/springyBot/jobManagement/form/jobPostingForm.vue')),
  //   hideMenu: true,
  ...
  {
    path: '/payment',
    component: createNameComponent(() => import('@/views/main/paymentPage/index.vue')),
    hideMenu: true,
    meta: { title: '支付頁面', hideTabs: true },
    props: { query: true },
  },
  {
    // 找不到路由重定向到404页面
